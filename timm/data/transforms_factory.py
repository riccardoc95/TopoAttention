...
from ._topo import TopoTransform
...
def transforms_imagenet_train(
    ...
    if topo:
        if separate:
            return transforms.Compose(primary_tfl), transforms.Compose(secondary_tfl), transforms.Compose(final_tfl), transforms.Compose([TopoTransform()])
        else:
            return transforms.Compose(primary_tfl + secondary_tfl + final_tfl + [TopoTransform()])
    else:
        if separate:
