                ...
                if args.save_images and output_dir:
                    if args.topo:
                        ...
                        torchvision.utils.save_image(
                            input[:,1:, :, :],
                            os.path.join(output_dir, 'train-input-batch-%d.jpg' % batch_idx),
                            padding=0,
                            normalize=True
                        )
                        torchvision.utils.save_image(
                            input[:,:1, :, :],
                            os.path.join(output_dir, 'train-topo-batch-%d.jpg' % batch_idx),
                            padding=0,
                            normalize=True
                        )
                    else:
                    ...
                    if args.denoising or args.segmentation:
                        torchvision.utils.save_image(
                            (torch.sigmoid(output) > 0.5) * 1.0 if args.segmentation else output ,
                            os.path.join(output_dir, 'train-output-batch-%d.jpg' % batch_idx),
                            padding=0,
                            normalize=True
                        )
                        torchvision.utils.save_image(
                            target,
                            os.path.join(output_dir, 'train-target-batch-%d.jpg' % batch_idx),
                            padding=0,
                            normalize=True
                        )
